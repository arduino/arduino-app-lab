...
import AppLabBrickMiscellaneous from './app-lab-brick-miscellaneous.svg?react';
import AppLabBrickStorage from './app-lab-brick-storage.svg?react';
...
import BeResponsibleIcon from './be-responsible-icon.svg?react';
...
import Redo from './redo-icon.svg?react';
import RegularExpression from './regular-expression.svg?react';
...
import SearchClearX from './search-clear-x.svg?react';
import SearchMagnify from './search-magnify.svg?react';
import SelectArrow from './select-arrow.svg?react';
...
import StopWatch from './stopwatch.svg?react';
...
const Images = {
  userAvatar: <img src={userAvatar} alt="User avatar" width="52" height="52" />,
  genAiBanner: <img src={genAiBanner} alt="Gen AI Banner" />,
  genAiBannerBg: <img src={genAiBannerBg} alt="Gen AI Banner Background" />,
};
